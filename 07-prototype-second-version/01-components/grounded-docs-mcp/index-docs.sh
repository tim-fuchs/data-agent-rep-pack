...
npx @arabold/docs-mcp-server@latest scrape "European XFEL DA Group" https://dataanalysis.pages.xfel.eu/user-documentation/ --scope subpages --scrape-mode playwright
npx @arabold/docs-mcp-server@latest scrape "European XFEL Website" https://xfel.eu/ --scope hostname --scrape-mode playwright
