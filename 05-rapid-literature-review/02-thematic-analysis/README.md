...
**Access the remote Jupyter Lab server** (OG 02)
...
**Interact with notebook content** (OG 02)
...
**Generate code optimized for high-performance computing** (OG 06)
...
**Test code for correctness and safety risks** (OG 03)
...
**Request user feedback to guide and improve solutions** (OG 09)
...
**Adapt code style and explanations to the user's expectations** (OG 09)
...
**Generate code documentation on project- and code-level** (OG 13)
...
**Request human approval for sensitive actions** (OG 04)
...
**Access relevant context information within a project** (OG 12)
...
**Decompose a request into verifiable goals** (OG 11)
...
**Work with up-to-date information** (OG 01)
...
**Close tasks with narrative summaries and recommended next steps** (OG 07)
...
**Support responses with citations, confidence levels, or verification steps** (OG 08)
...
**Assist in drafting scientific manuscripts** (OG 10)
...
**Recommend using a version control system** (OG 14)
...
**Not share user data with third parties** (OG 05)
