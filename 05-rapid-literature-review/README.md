...
What are requirements for an agentic AI system that supports data scientists and natural scientists in writing source code for data analysis?
...
- Note: List of search queries is based on the following ChatGPT search query and multiple interactions afterward (2026-03-13): "I want to conduct a rapid multi-vocal literature review via Google, Google Scholar, and Consensus AI to review lessons learned from studies about human-ai interaction in the fields of software engineering and science. List good search terms."
...
- Data processing:
  ...
  - Automatic and manual download of each article, either as HTML and PDF file
  - Automatic conversion of HTML/PDF files to Markdown files.
  - Manual cleaning of Markdown files by removing irrelevant prefixes and suffixes. Reduction from ~95k to ~50k characters on average per article.

## 5. Data Analysis Steps (see analysis.xlsx file)
...
- Relevance screening:
  ...
  - Full-text reading
- Data extraction
- Reporting (via PRISMA checklists and diagrams)
  - Biases/limitations:
    - Limited search strings
    - No snowballing
    - Only one human coder (no peer review)

## 6. Results

- 224 relevant articles (141 peer-reviewed publications, 46 preprints, 36 blog posts, 1 technical report)
- 5365 requirements extracted (3062 from GPT-5.4-mini, 2303 from Minimax-M2.5; duplicates included)
